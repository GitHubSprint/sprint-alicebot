...
public class MagicStrings {
    ...
    public static String unknown_session_id = "unknown";
    public static String unknown_bot_name = "bot";
    ...
    public static String too_much_recursion()
    {
        ...
        if(default_language.equals("PL"))
            return "ERR|Przepraszamy wystąpił problem techniczny. Za dużo rekurencji w AIML";
        else
            return "ERR|Too much recursion in AIML";
    }
    public static String too_much_looping(){
        // = "Too much looping in AIML";
        if(default_language.equals("PL"))
            return "ERR|Przepraszamy wystąpił problem techniczny. Zbyt dużo zapętleń w AIML";
        else
            return "ERR|Too much looping in AIML";
    }
